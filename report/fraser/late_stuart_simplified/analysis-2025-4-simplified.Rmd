---
title: "Simplifying down the analysis-2025-4.Rmd from Late Stuart"
...
knitr::opts_chunk$set(
  ...
  comment = "",
  cache = TRUE,
  cache_path = "analysis-2025-4-simplified-cache/",
  fig.path = "analysis-2025-4-simplified-figs-cache/",
  fig.width = 7,
  fig.height = 6
)
...
rmarkdown::render("analysis-2025-4-simplified.Rmd")
```
...
library(dplyr)
library(pbsEDM)
library(pacea)    # make sure to update, see https://github.com/pbs-assess/pacea
library(gridExtra)
library(ggplot2)
