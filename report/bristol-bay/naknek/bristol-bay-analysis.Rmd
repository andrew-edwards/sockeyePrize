...
```
So max excluded is about `r f(max(river_returns_2$total_difference)/max(river_returns_2$total_of_included)* 100)`% of the maximum total (might not be the same year).
<!-- for naknek copied from columbia, having already done previous Bristol Bay ones -->
