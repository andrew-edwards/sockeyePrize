...
Next:
  ...
  - do Fraser River discharge as is important.
...
plot(halibut_bank_spring$year,
     halibut_bank_spring$spring_sst,
     type = "o",
     xlab = "Spring SST",
     ylab = "Year")
...
Do the correlation plot first before truncating (expect it just ignores NA's),
