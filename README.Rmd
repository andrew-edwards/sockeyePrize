...
data-raw/data-2026.Rmd - wrangling the data from salmon pri`e people, only Columbia so
far.
...
Only done for Columbia River so far, but this can be used as a template for
...
Columbia data is all we have at the moment for the salmon prize competition,
hence the focus on that stock. This code is tidied up from last year's.
